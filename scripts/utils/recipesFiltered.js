...
//     // const appliances = collectAppliances(filteredRecipes);
//     // console.log(appliances);
//     // const ingredients = collectIngredients(filteredRecipes);
//     // console.log(ingredients);
//     // const ustensils = collectUstensils(filteredRecipes);
...
//         if(ingredients.includes(research)){
//             recipesSelected.push(recipes[i]); 
//             }

//         if(ustensils.includes(research)){
//             recipesSelected.push(recipes[i]); 
//         }
